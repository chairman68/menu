...
<div id="order"
    ...
    <table cellspacing="0" style="border-bottom: solid grey 2px; border-top: solid grey 2px; border-collapse:collapse; " width="790px">
		...
		$min_sum = 50000; // минимальная сумма на низкий сезон
		$condition = ' ЗАКАЗЧИК обязуется в срок, указанный в п. 2.2., сделать заказ по блюдам кухни  на сумму не менее чем 50 000 руб. и из расчета не менее 1350 рублей на одного гостя.  '; //
        /*
        Условия на низкий сезон
...
<?php //   --------------  Вывод таблицы с составом заказа --------------------?>
    ...
    <table cellspacing="0" width="800px" style="padding: 5px;">
       ...
       <?php // ------------- Цикл построчного вывода позиций -------------------
        ...
        <tr>
            <td  colspan="2" rowspan="3" style="font-size: 16px;">Справочная информация:</td>
            <td colspan="5" style="text-align: right;">Стоимость блюд без услуг:</td>
            <td style="text-align: right;"><?=round($dishes_total)?> руб.</td>
