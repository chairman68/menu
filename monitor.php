...
$orders_quantity_1=count_orders_period($conn,$date->format("Ymd 08:00:00"),$date->format("Ymd 10:59:59"));
$orders_quantity_2=count_orders_period($conn,$date->format("Ymd 11:00:00"),$date->format("Ymd 11:59:59"));
$orders_quantity_3=count_orders_period($conn,$date->format("Ymd 12:00:00"),$date->format("Ymd 12:59:59"));
$orders_quantity_4=count_orders_period($conn,$date->format("Ymd 13:00:00"),$date->format("Ymd 13:59:59"));
$orders_quantity_5=count_orders_period($conn,$date->format("Ymd 14:00:00"),$date->format("Ymd 14:59:59"));
$orders_quantity_6=count_orders_period($conn,$date->format("Ymd 15:00:00"),$date->format("Ymd 15:59:59"));
$orders_quantity_7=count_orders_period($conn,$date->format("Ymd 16:00:00"),$date->format("Ymd 23:59:59"));
...
<body>
    <iframe src="/reports/rpt-sales.php?date_begin=<?=$date->format("Ymd")?>&date_end=<?=$date->format("Ymd")?>" width="39%" height="930px" frameborder="0"  style="float:right; margin-right:1%;">
